...
import findRoute, {
  getUrlQuery,
} from '/Users/xuliheng/Documents/study/react-template-pc/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/xuliheng/Documents/study/react-template-pc',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
